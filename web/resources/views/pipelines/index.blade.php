	...
	<x-app>
		<div class="mt-12 md:flex md:items-center md:justify-between">
			<div class="min-w-0 flex-1">
				<h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">pipelines</h2>
			</div>
			<div class="mt-4 flex md:ml-4 md:mt-0">
				<a href="{{ route('pipelines.create') }}" class="inline-flex items-center bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">new</a>
			</div>
		</div>
		...
		<div class="mt-8 border border-dashed border-gray-900/25 p-8">
			<h2 class="text-lg font-semibold leading-7 text-black">create your first pipeline</h2>
			<p class="mt-1 leading-6 text-gray-600">get started by selecting a template or start from an empty pipeline.</p>
			...
			<div class="mt-6 flex">
				<a href="{{ route('pipelines.create') }}" class="font-medium text-black underline">
					or start from an empty pipeline
			...
			<li class="relative flex items-center space-x-4 py-6">
				<div class="min-w-0 flex-auto">
					...
					<div class="mt-1 flex items-center gap-x-2.5 text-sm leading-5 text-gray-500">
						<p class="truncate">{{ $pipeline->description }}</p>
